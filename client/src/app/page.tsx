          ...
          {[
            {
              ...
              icon: 'Refresh',
              title: 'Round Robin',
              desc: 'One request each, taking turns',
              detail: 'Each request goes to the next server in line, then back to the first. Every server gets an equal share. Simple, fair, and predictable.',
            ...
            },
            {
              ...
              desc: 'Bigger servers get more traffic',
              detail: 'You give each server a number, and it gets that share of the traffic. A server set to 40 receives roughly 40% of all requests.',
            ...
            },
            {
              ...
              icon: 'Key',
              title: 'IP Hash',
              desc: 'Same visitor, same server, every time',
              detail: 'The visitor\'s IP address decides which server they get, so they always land on the same one. No cookies needed.',
            ...
            },
            {
              ...
              desc: 'A visitor stays on one server',
              detail: 'The first request picks a server, and a cookie keeps that visitor there for the rest of their visit. Nothing they were doing gets lost mid-way.',
            ...
            },
            {
              ...
              desc: 'Bigger servers get more visitors, who then stay',
              detail: 'New visitors are shared out by server size, and a cookie then keeps each one on the server they were given.',
            ...
            },
            {
              ...
              icon: 'Shield',
              title: 'Failover',
              desc: 'Main server first, backup when it breaks',
              detail: 'Everything goes to your main server. The moment it stops responding or returns an error, the next server on the list takes over automatically.',
            ...
            },
            {
              ...
              desc: 'Visitors go to the nearest server',
              detail: 'Each visitor is sent to the server closest to them — matched by city first, then country, then continent, with a fallback if nothing matches.',
